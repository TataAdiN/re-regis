...
<head>
  ...
  <title>Selamat Datang! Tata..</title>
  ...
  <div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="<?= base_url('student') ?>" class="navbar-brand sidebar-gone-hide">ABC</a>
      ...
      <nav class="navbar navbar-secondary navbar-expand-lg">
        <div class="container">
          <ul class="navbar-nav">
            <li class="nav-item {{ $num == 1 ? 'active' : '' }}">
              <a href="{{ base_url('student') }}" class="nav-link"><i class="fas fa-home"></i><span>Beranda</span></a>
            </li>
            <li class="nav-item {{ $num == 2 ? 'active' : '' }}">
              <a href="{{ base_url('student/bio') }}" class="nav-link"><i class="far fa-edit"></i><span>Bio Data</span></a>
            </li>
